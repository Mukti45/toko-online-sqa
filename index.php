                    ...
                    <table class="table bg-white shadow-sm">
                        ...
                        <?php foreach ($produkList as $kode => $item): ?>
                            <tr>
                                ...
                                <td><?= $item['stok'] ?></td>
                                <td>
                                    <input type="number" name="qty[<?= $kode ?>]" min="0"
                                        max="<?= $item['stok'] ?>" value="0"
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="text-muted small">
                                🚚 Ongkir: Rp 20.000<br>
                                ✅ Gratis ongkir jika total &gt; Rp 500.000<br>
                                🎁 Diskon 10% jika total &gt; Rp 1.000.000
                            </p>
                            <input type="email" name="email" class="form-control mb-2"
                                value="<?= htmlspecialchars($_SESSION['user']['email'] ?? '') ?>"
                                placeholder="Email Anda" required>
                            <textarea name="alamat" class="form-control mb-3"
                                placeholder="Alamat Pengiriman Lengkap" required></textarea>
