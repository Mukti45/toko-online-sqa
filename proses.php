                ...
                <div class="card border-success shadow">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush mb-4">
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                Total Harga Barang
                                <span>Rp <?= number_format($nota['total_harga_barang'], 0, ',', '.') ?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                Diskon
                                <span class="text-danger">- Rp <?= number_format($nota['diskon'], 0, ',', '.') ?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                Ongkos Kirim
                                <span>Rp <?= number_format($nota['ongkos_kirim'], 0, ',', '.') ?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                Total Item Dibeli
                        ...
                        <div class="p-3 bg-light rounded text-center">
                            ...
                            <small class="text-muted">(Sudah termasuk ongkir & diskon)</small>
                        </div>
                    </div>
